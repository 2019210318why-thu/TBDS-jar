...
1、【基本信息】配置 ![pic\_17](../../.gitbook/assets/pic_17.png)
...
接入的源数据库表信息：`源DB：tdbank, 源Table:student, teacher`，接口名称：`db2HDFSTest` ![pic\_07](../../.gitbook/assets/pic_07.png)

配置对应的目的数据接口：选择自动创建`tdbank_student`hive表 ![pic\_18](../../.gitbook/assets/pic_18.png)

![pic\_19](../../.gitbook/assets/pic_19.png)
...
该接口使用的Hippo Topic名称为：`hdfs_topic_01` ![pic\_20](../../.gitbook/assets/pic_20.png)
...
![pic\_21](../../.gitbook/assets/pic_21.png)

![pic\_22](../../.gitbook/assets/pic_22.png)
...
点击数据接入详情，查看数据流向： ![pic\_23](../../.gitbook/assets/pic_23.png)

在Hippo管理界面查看，对应Topic的生产消费情况（Agent数据采集、TDSort落地情况） ![pic\_24](../../.gitbook/assets/pic_24.png)

在【进度监控】-&gt;【数据明细】查看对账数据 ![pic\_25](../../.gitbook/assets/pic_25.png)
